...
![Figure 1 ｢数列のマジック｣(a,b)=(2,1)の場合](Figure1.png)
...
![Figure 2 理論厳密解との比較（短期間）](Figure2.png)
...
![Figure 4 両解の比較（長期間) (time step $\Delta t=0.1$)](Figure4.png)
...
![Figure 6 30万回時間発展を計算しても振幅が小さくならない（左）が，うなり現象が見える（右）](Figure6.png)
...
![Figure 8 MATLABでの2次元の波動伝播](Figure8.png)

*Figure 8: MATLABでの2次元の波動伝播のアニメーションの一場面の静止画像*


![Figure 9 Pythonでの2次元波動伝播動画の静止画スナップショット](Figure9.png)
