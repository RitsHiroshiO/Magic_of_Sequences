...
Since computing environments and performance changed over time, I asked Gemini to make a table that includes this context (Table in Section 6.2). Gemini also checked which numerical analysis textbooks cover these topics, and I added this to the table. Most interestingly, Gemini explained that modern AI uses the concept of energy conservation for data learning and future prediction with great success.

## 6.2 Evolution of Numerical Analysis and Computing Environments (18th Century - Present) Generated by Gemini
...
## 6.3 Chronological Historical Background and Story Generated by Gemini

### 6.3.1 Dawn: Era of Brains and Paper (Late 18th - Late 19th Century) `[1]`
...
### 6.3.2 Era of Human Waves and Hand Calculators (1907: Störmer) `[1]`
...
### 6.3.3 Era of Electronic Computers and Extreme Memory Shortage (1967: Verlet) `[1]`
...
### 6.3.4 Visualizing the Failure via Supercomputers (1970s - 1980s) `[1]`
...
### 6.3.5 Era of Mathematics, Physics, and Proof (1994 - 2006) `[1]`
...
### 6.3.6 The AI Era: Infinite Computing Power and Return to Physical Laws (2019 - Present)
...
Before the rise of AI, I faced the following problems. Science and engineering made great progress by adding exact mathematical and physical solutions to logical models. However, when we made numerical predictions based on constitutive laws or data with limited accuracy and errors, the predictions were often difficult, or the results deviated from physical laws. At that time, there was no solution other than temporary and empirical corrections. For example, to get the calculation results of the relaxation method faster than traditional methods, the SOR (Successive Over-Relaxation) method was invented. This method mechanically increases the correction amount by a constant multiplier. I have experienced both the advantages and disadvantages of such methods.
...
Note: Wikipedia is not as authoritative as peer-reviewed journals, but the content compiled in this table (Table 6.2) can also be traced, to some extent, via the entries `[10]`.
...
`[10]`: The Wikipedia entries that readers may be able to trace back to some extent. [Carl Størmer](https://en.wikipedia.org/wiki/Carl_St%C3%B8rmer), [UNIVAC 1100/2200 series](https://en.wikipedia.org/wiki/UNIVAC_1100/2200_series), [Verlet integration](https://en.wikipedia.org/wiki/Verlet_integration), [Cray-1](https://en.wikipedia.org/wiki/Cray-1), [Workstation](https://en.wikipedia.org/wiki/Workstation), [SPARCstation](https://en.wikipedia.org/wiki/SPARCstation), [Personal computer (History Section)](https://en.wikipedia.org/wiki/Personal_computer)
